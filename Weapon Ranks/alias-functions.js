...
var wr01 = ItemControl.isWeaponAvailable;
ItemControl.isWeaponAvailable = function(unit, item) {
    var available = wr01.call(this, unit, item);
...
var wr02 = ItemControl.isItemUsable;
ItemControl.isItemUsable = function(unit, item) {
    available = wr02.call(this, unit, item);
...
var wr05 = NormalAttackOrderBuilder._endVirtualAttack;
NormalAttackOrderBuilder._endVirtualAttack = function(virtualActive, virtualPassive) {
    wr05.call(this, virtualActive, virtualPassive);
...
var wr06 = ItemExpFlowEntry._completeMemberData;
ItemExpFlowEntry._completeMemberData = function(itemUseParent) {
    wr06.call(this, itemUseParent);
...
var wr07 = Calculator.calculateRecoveryItemPlus;
Calculator.calculateRecoveryItemPlus = function(unit, targetUnit, item) {
    var plus = wr07.call(this, unit, targetUnit, item);
    var defaultItemType = root.getBaseData().getWeaponTypeList(3).getDataFromId(1);
...
var wr08 = ParameterControl.addDoping;
ParameterControl.addDoping = function(unit, obj) {
    wr08.call(this, unit, obj);    
...
var wr09 = AttackFlow.moveEndFlow;
AttackFlow.moveEndFlow = function() {
    var result = wr09.call(this);
